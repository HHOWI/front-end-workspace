...
// h4 중 클래스 선택자 test가 아닌 요소를 선택해 배경색상 : chocolate, 글자색 : white
$('h4').not('.test').css({
...
// .wrap인 요소의 모든 하위 요소중 span 태그의 style5를 적용
...
$('.wrap2 h2').prevUntil('.wrap h2').css('font-size', '2rem');