...
$('#content2').children('a').prop('href', 'https://naver.com');

console.log($('.content').html());
$('.content').html('zzzzzzzzzz');
...
$('#content4').html('<strong>Hello~</string>');
...
// 1) remove
// remove 버튼 클릭시 #item2를 remove로 제거 후 #remove-result에 리턴값 출력
$('#remove').click(function(){
    const remove = $('#item2').remove();
    $('#remove-result').html(remove);
});
// 2) detach
// detach 버튼 클릭시 #item2를 detach로 제거 후 #remove-result에 리턴값 출력
